...
* 如原PID输出为正， $\tau_i = \frac{-B + sqrt(\Delta)}{2A}$
  ...
  $$
  \tau_i = \frac{-\omega_i + \sqrt{\omega_i^2 - 4k_{2}(k_{1}\left|\omega_i\right| + k_3 / n - {P}_i)}}{2k_2}
  $$
...
$$
{P}_{max} = {P}_{ref}^{max} - K_pe(t) - K_d\frac{e(t)-e(t-1)}{\Delta t}
$$
